...
if(isset($_POST['txtsub']) && $_POST['txtsub'] === 'register') {
    $data = new Data($conn);
    ...
    if ($password != $repass) {
        ...
        $email_exists = $data->select_email($email);

        if (!$email_exists) {
            $insert = $data->insert_user($username, $password, $email);
            ...
            if ($insert) {
                ...
                echo "<script>alert('Không đăng ký được.')</script>";
            }
        } else {
...
<body>
  ...
  <div class="container">
    <ul class="menu">
      <li><a href="index.php">Trang chủ <i class="gg-chevron-right"></i></a></li>
      <li><a href="dangky.php">Đăng Ký <i class="gg-chevron-right"></i></a></li>
    </ul>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingName" placeholder="Full Name" name="txtusername" required>
            <label for="floatingName">Họ và tên</label>
        </div>
        <div class="form-floating mb-3">
            <input type="email" class="form-control" id="floatingEmail" placeholder="Email" name="txtemail" required>
            <label for="floatingEmail">Email</label>
        </div>
        <div class="form-floating mb-3">
            <input type="password" class="form-control" id="floatingPassword" placeholder="Mật khẩu" name="txtpassword" required>
            <label for="floatingPassword">Mật khẩu</label>
        </div>
        <div class="form-floating mb-3">
            <input type="password" class="form-control" id="floatingConfirmPassword" placeholder="Xác nhận mật khẩu" name="txtrepass" required>
        ...
        <div class="d-grid">
            <button class="btn btn-primary btn-register text-uppercase fw-bold" type="submit" name="txtsub" value="register">Đăng ký</button>
        </div>
    </form>
