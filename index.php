...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<img class="card-img-top" data-src="" alt="Hình thu nhỏ [100%x225]"';
        echo 'style="height: 225px; width: 100%; display: block;" src="admin/advance-admin/uploads/' . $row['Anh'] . '"';
        echo 'data-holder-rendered="true">';
        echo '<div class="card-body">';
        echo '<p class="card-text">';
        echo '<font style="vertical-align: inherit;">';
        echo '<font style="vertical-align: inherit;">' . $row['TenXe'] . '</font>';
        echo '<br>';
        echo '<span>' . $row['NamSanXuat'] . '-Tự Động-' . $row['SoKmDaChay'] . '</span>';
        echo '<br>';
        echo '<span>Giá Bán: ' . $row['Gia'] . '</span>';
        echo '<br>';
        echo '<span>Nơi bán: ' . $row['NoiBan'] . '<br>Ngày bán: ' . $row['NgayBan'] . '</span>';
        echo '</font>';
        echo '</p>';
        ...
        echo '<font style="vertical-align: inherit;">';
        echo '<font style="vertical-align: inherit;">';
        echo '<a href="chitiet.php?id=' . $row['ID'] . '" style="text-decoration:none; color: black;">Xem Chi Tiết</a>';
        echo '</font>';
        echo '</font>';
        echo '</button>';
        echo '<button class="add-to-cart" data-id="' . $row['ID'] . '" data-title="' . $row['TenXe'] . '" data-price="' . $row['Gia'] . '" data-image="admin/advance-admin/uploads/' . $row['Anh'] . '">';
        echo '<span class="gg-shopping-bag"></span>';
        echo '</button>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
