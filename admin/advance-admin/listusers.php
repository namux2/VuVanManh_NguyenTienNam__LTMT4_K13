...
<body>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop "></i>List register <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                             <li>
                                <a class="active-menu" href="listusers.php"><i class="fa fa-key "></i>Users</a>
                            </li>
                            <li>
    ...
    <tbody>
        ...
        include('control.php');
        $getdata = new data();
        $select_all = $getdata->se_all('users');

        foreach ($select_all as $se_user) {
            ?>
            <tr>
                <td><?php echo $se_user['id'] ?></td>
                <td><?php echo $se_user['username'] ?></td>
                <td><?php echo $se_user['password'] ?></td>
                <td><?php echo $se_user['email'] ?></td>
                <td><?php echo $se_user['role'] ?></td>
                <td>
                    <a href="delete_all.php?del_user=<?php echo $se_user['id'] ?>" onclick="return(confirm('Bạn có chắc muốn xóa?'))">
                        <span class="glyphicon glyphicon-remove"></span>
                    </a>
                </td>
                <td>
                    <a href="edit_user.php?id=<?php echo $se_user['id'] ?>">
